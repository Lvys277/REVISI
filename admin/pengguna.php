        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;padding-top:10px;padding-bottom:10px;padding-left:10px;" class="mini-headign">Detail Pengguna</h3>
    ...
    <table class="table table-bordered" id="myTable">
        <thead >
            <tr>                         
                ...
                <th style="text-align:center;background:#2B2C44;color:white;" scope="col">EMAIL</th>
        ...
        <tr style="background:grey;">    
                ...
                <td style="background-color:#2B2C44;color:white;"><?php echo $row['email'] ?></td>
