        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;padding-top:10px;padding-bottom:10px;padding-left:10px;" class="mini-headign">Detail Obrolan</h3>
    ...
    <table class="table table-bordered" id="myTable">
        <thead>
            <tr>                   
                ...
                <th style="text-align:center;background:#2B2C44;color:white;" scope="col">PESAN</th>
        ...
        <tr>    
                ...
                <td style="background:#2B2C44;color:white;"><?php echo $row['nama'] ?></td>   
                <td style="background:#2B2C44;color:white;"><?php echo $row['msg'] ?></td>
              <td style="background:#2B2C44;" class="text-center">   
