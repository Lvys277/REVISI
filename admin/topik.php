        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;padding-top:10px;padding-bottom:10px;padding-left:10px;" class="mini-headign">Detail Postingan</h3>
              <div style="padding-left:10px;padding-right:10px;" class="card-body"> 
    <table class="table table-bordered" id="myTable">
        <thead>
            <tr>                        
                <th style="text-align:center;background:#2B2C44;color:white;" scope="col">NAMA</th>
                <th style="text-align:center;background:#2B2C44;color:white;" scope="col">DESKRIPSI</th>
                <th style="text-align:center;background:#2B2C44;color:white;" scope="col">GAMBAR</th>
        ...
        <tr>    
                ...
                <td style="background-color:#2B2C44;color:white;"><?php echo $row['nama'] ?></td>   
                <td style="background-color:#2B2C44;color:white;"><?php echo $row['deskripsi'] ?></td>
                <td style="background-color:#2B2C44;color:white;"><?php if (!empty($row['gambar1'])) { ?>
                <img src="../image/<?php echo $row['gambar1']; ?>" style="width: 100px;">
                <?php } else {
                    echo '-';
                } ?></td>
                <td style="background-color:#2B2C44;"class="text-center">   
                    <a href="hapus-topik.php?id=<?php echo $row['id']?>" class="btn btn-sm btn-danger">HAPUS</a>    
               </td>
            </tr>
            <?php
            }?>
