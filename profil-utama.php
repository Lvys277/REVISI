    ...
    <div class="container">
      <div class="home-weapper">
        ...
        <div style="background-color:#2B2C44;" class="home-left">
          ...
          <div class="explore">
            ...
            <a style="margin-top:10px;margin-bottom:20px;padding-right:90px;" href="index.php"><i class="fa-solid fa-home"></i>Beranda</a>
        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;" class="mini-headign">Profil</h3>
              <?php
      $pdo = new PDO('mysql:host=localhost; dbname=pkl', "root", "");
      ...
      while ($komentar = $query2->fetch()) {
        ...
        <div class="row mb-3">
            ...
            <div class="col">
              <div>
              <div style="float:left;padding-top:20px;margin-bottom:30px;padding-bottom:15px;margin-left:40px;" class="">
                
                  <?php if (($_SESSION['user']['id']) == ($_GET['id'])) { ?>
                    <button type="button" style="border-color:#2B2C44;" class="btn " data-bs-toggle="modal"
                  ...
                  <?php } else { ?>
                    ...
                    <div style="margin-left:15px;margin-right:13px;max-height:200px;max-width:200px;border-radius:50%;overflow:hidden;margin-bottom:15px;">
                  ...
                  <div style=""class="row">
                    <div style="font-size:50px;margin-left:35px;padding-top:10px;color:white;" class="col fw-bold">
                ...
                while ($komentar = $query2->fetch()) {
                  ...
                  <p class="uil uil-home" style="padding-top:10px;font-size:14px;color:white;margin-left:312px;"> Tinggal di <a
                      style="font-weight:bold;">
                      <?php echo $komentar['tinggal']; ?>
                    </a></p>
                  <p class="uil uil-map-marker" style="font-size:14px;color:white;margin-left:312px;"> Lahir di <a style="font-weight:bold;">
                      <?php echo $komentar['lahir']; ?>
                    </a></p>
                  <p class="uil uil-user" style="font-size:14px;color:white;margin-left:312px;"> Jenis Kelamin <a style="font-weight:bold;">
                      <?php echo $komentar['jk']; ?>
                    </a></p>
                  <p class="uil uil-gift" style="font-size:14px;color:white;margin-left:312px;"> Tanggal Lahir <a style="font-weight:bold;">
            ...
            <div style="background-color:#2B2C44;" class="fb-post1">
              <div style="margin-left:-20px;margin-right:-15px;" class="fb-post1-container">
                
                <h3 style="padding-left:15px;margin-bottom:-30px;color:white;padding-bottom:20px;" class="mini-headign">Postingan</h3>
        ...
        while ($komentar = $query2->fetch()) { ?>
          <figure>
            <div style="margin-top:48px;padding-left:15px;" class="">
              <blockguote class="blockquote">
                ...
                <div style="font-weight:bold; padding-top: 20px; font-family:arial; margin-bottom: 15px;color:white;">
                  <?php echo htmlentities($komentar['nama']); ?><br>
                </div>
                <div style=";color: #a7a7a7;padding-right:15px;">
                  <hr>
                </div>
                <a style="text-decoration:none; color:black;font-size:19px;font-family:arial;color:white;" <?php echo $komentar['id'] ?>><?php echo htmlentities($komentar['deskripsi']); ?></a><br>
                <?php
                ...
                <div style="color: #a7a7a7;padding-right:15px;">
                  ...
                  <a href="hapus-topik.php?id=<?php echo $komentar['id']; ?>"
                    onclick="return confirm('Apa anda yakin ingin menghapus Postingan?')" class="text-danger"
                    style="text-decoration: none;font-size: 15px;">hapus</a> 
                  <small style="margin-left:443px;font-size:12px;margin-bottom:50px;color:#7B7B7C;">
                    <?php echo date('d M Y H:i', strtotime($komentar['tanggal'])); ?>
                  </small>
                  <?php } else {?>
            <small style="margin-left:505px;font-size:12px;margin-bottom:50px;color:#7B7B7C;">
            <?php echo date('d M Y H:i', strtotime($komentar['tanggal'])); ?>
          </small>
          <?php } ?>
