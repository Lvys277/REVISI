        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;" class="mini-headign">Edit Profil</h3>
              <div class="col-12">
                        <form action="simpan-edit-profil.php" method="POST"
                            style="margin-left:25px;margin-right:25px;padding-top:10px;font-size:16px;">
                            <div style="margin-bottom:20px;" class="post-icon">
                            <a href="tambah-profil.php" style="background: #ffe8ed;font-size:17px;">
                            <i style="background: #ff1baa;font-size:17px;" class="fa-solid fa-address-card"></i>
                            Tentang Anda</a>
                            </div>
                            <h5 style="color:white;">Ganti Nama Atau Email</h5>
                            <p style="color:#4575B3;" >Kosongkan jika tidak diganti</p>
                            <div class="mb-3">
                                <label style="font-weight:bold;color:white;" class="form-label">Nama</label>
                            ...
                            ?>
                            <div class="mb-3">
                                <label style="font-weight:bold;color:white;" class="form-label">Email</label>
                            ...
                            <h5 style="color:white;">Ganti Password</h5>
                            <p style="color:#4575B3;">Kosongkan jika tidak diganti</p>
                            <?php
                            if ($_GET['req'] == 6) {
                            ...
                            <div class="mb-3">
                                <label style="font-weight:bold;color:white;" class="form-label">Password lama</label>
                            ...
                            <div class="mb-3">
                                <label style="font-weight:bold;color:white;" class="form-label">Password baru</label>
                            ...
                            <div class="mb-3">
                                <label style="font-weight:bold;color:white;" class="form-label">Ketik ulang Password baru</label>
            ...
            <section class="users">
              <header>
                ...
                <div class="messenger-search">
                  ...
                  ?>
                  <img src="image/<?php echo $row['gambar']; ?>" style="border-radius:50%;"alt="">
                  <div  class="details">
