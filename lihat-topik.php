        ...
        <div class="home-center">
          <div class="home-center-wrapper">
            <div style="background-color:#2B2C44;" class="createPost">
              <h3 style="color:white;" class="mini-headign">Komentar</h3>
              <?php
            if (isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                if (empty($topik)) {
                    ...
                    <figure class="bg1">
                        <div class="row"
                            style="font-weight:bold; padding-left:15px; padding-top: 17px; font-family:arial; font-size:25px;color:white;">
                            <img src="image/<?php echo $topik['gambar']; ?>"
                                style="width: 80px;border-radius:50%;margin-top:-1px;color:white;">
                            <?php echo htmlentities($topik['nama']); ?>
                            <p style="font-size:12px;margin-left:67px;margin-top:-22px;color:#7B7B7C;" >
                                <?php echo date('d M Y H:i', strtotime($topik['tanggal'])); ?>
                            </p>
                            <br>
                        </div>
                        <p
                            style="padding-left:16px;margin-top:-34px;margin-bottom:20px;font-weight:bold;font-size:20px;padding-right:16px;color:white;">
                            <?php echo htmlentities($topik['deskripsi']); ?>
                        </p>

                        <?php
                        if (!empty($topik['gambar1'])) { ?>
                            <img src="image/<?php echo $topik['gambar1']; ?>" style="width:645px;margin-left:-15px;">
                        <?php } else {
                            echo '';
                        } ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-auto">
                                    <div style="padding-left:18px;padding-right:15px" class="col">
                                        <div style="background-color:white" class="py-2 px-3 rounded">
                                            <div style="color:black;font-size:15px;"class="row">
                                                ...
                                                <?php if (($_SESSION['user']['id']) == ($komentar['id_user'])) { ?>
                                                    ...
                                                    <div class="col-auto">
                                                        <a style="text-decoration:none;" href="hapus-komentar.php?id=<?php echo $komentar['id']; ?>"
                                                            onclick="return confirm('Apa anda yakin ingin menghapus komentar?')"
                                                            class=""><small style="color:red;">hapus</small></a>
                                                    </div>
                                                <?php } else {
                                                    echo '';
                                                } ?>
                                                <div class="col-auto">
                                                    <small style="color:#7B7B7C;" class="">
              ...
              <div style="margin-left:-20px;" class="fb-post1-container">
              <?php
                if (isset($_GET['id']) && !empty($_GET['id'])) {
                    $pdo = new PDO('mysql:host=localhost; dbname=pkl', "root", "");
                ...
                <form method="POST" action="jawab-topik.php">
                    ...
                    <div style="margin-bottom:-22px;" class="wrapper">
                        <textarea style="height:55px;" spellcheck="false" name="komentar" placeholder="Ketik Sesuatu di Sini..."
                            required></textarea>
                        <input type="hidden" value="<?php echo $topik['id']; ?>" name="id_topik" />
                        <button style="color: #4575B3;font-size:30px;margin-left:520px;margin-top:-92px;" type="submit" class="btn fa-solid fa-paper-plane"></button>
                    </div>
